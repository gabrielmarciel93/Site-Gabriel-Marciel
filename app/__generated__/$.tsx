...
import { HtmlEmbed as HtmlEmbed } from "@webstudio-is/sdk-components-react/components";
      ...
      export const projectDomain = "gabriel-marciel-portfolio-jvorb";

      export const lastPublished = "2026-02-21T08:00:00.488Z";
      ...
      export const pageFontAssets: string[] =
        ["DMSans-VariableFont_opsz_wght_0nlVRsSMOXtybRd9LDPDS.ttf"]
...
return <Body
className={`w-element c1ij51x0 c18n3o80 c1a4zjes c1fl243r`}>
<div
className={`w-element`}>
<div
className={`w-element c4cs9kk cfo00z7 c19aomgz c1fwnqp9 c530lg9 c1us4q23`}>
<div
className={`w-element`}>
{"404"}
</div>
<div
className={`w-element c16wy52z c1lygkdd c1yackvh cejpodb c1pf4z8f cp8c5kc`}>
{"404"}
</div>
<div
className={`w-element c16wy52z c1lygkdd cn4womu cejpodb cynd89v cp8c5kc`}>
{"404"}
</div>
<div
className={`w-element c16wy52z c1ctshrq chilnvq cr6ud55 c1fl243r c1nsjg3m`} />
</div>
<p
className={`w-element c11a1oz6 ch2vy06 cn1f0iv c1ol8iu0 c7if4l1`}>
{"PAGE NOT FOUND"}
</p>
</div>
<div
...
target={"_blank"}
className={`w-element c14w5203 cjczsls ctjdz1f c1a4zjes c18n3o80 c1ndp2is c8vaqc7 c12jelf0 cb1zu2a cu2wqyl c1c76fqy c1x60vc4 cgyy5tz c12sflq3 c1p30eyj c1y5vznx caj7ff2 c530lg9 c1lycng8 c1ympiav cujb0b4 c1dzh6zo cq92p79 cbvgw49 c11v9l0t cl65zgv czykhzb cf1dusu`}>
<HtmlEmbed
...
className={`w-html-embed c74ily4 c8ogacn crio97g ckh31ih`} />
<div
className={`w-element`}>
